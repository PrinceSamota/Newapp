...
ActiveRecord::Schema[7.2].define(version: 2026_08_02_112020) do
  ...
  create_table "client_driver_var_nos", force: :cascade do |t|
    t.string "name"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
